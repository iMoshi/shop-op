        ...
        <Row noGutters>
          <Col xs={12}>
            <div className="tt-promo-fullwidth">
              <img
                src="/assets/images/skins/foods/promo-img-01.jpg"
                alt="moni-food"
              />
              <div className="tt-description tt-point-h-l">
                <div className="tt-description-wrapper text-left">
                  ...
                  <p className="tt-white-color">
                    A great about us block helps builds trust between you and
                    your
                    <br />
                    customers. The more content you provide about you and your
                    business,
                    <br />
                    the more confident people will be when purchasing from your
                    store.
                  </p>
                </div>
              </div>
