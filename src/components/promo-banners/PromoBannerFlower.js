  ...
  return (
    <div className={`container-indent ${className ? className : className}`}>
      <Container className="container-fluid-custom-mobile-padding">
        <SectionTitle title="Treat<br>someone special" />
          ...
          <Col sm={6} className="col-12-440width">
            <div className="tt-promo02 text-center">
              <Link href="/product/category/flower">
                <a>
                  <img
                    src="/assets/images/skins/flowers/img-02.jpg"
                    alt="moni"
                  />
                </a>
              </Link>
              ...
              <div className="tt-description">
                ...
                <p>
                  Beautiful, fresh flowers chosen and hand tied by our talented
                  florists for any occasion.
                </p>
                <Link href="/product/category/flower">
          ...
          <Col sm={6} className="col-12-440width">
            <div className="tt-promo02 text-center">
              <Link href="/product/category/flower">
                <a>
                  <img
                    src="/assets/images/skins/flowers/img-03.jpg"
                    alt="moni"
                  />
                </a>
              </Link>
              ...
              <div className="tt-description">
                ...
                <p>
                  Our decadent cupcakes and treats are the perfect extra touch
                  to our stunning arrangements and are guaranteed to please.
                </p>
                <Link href="/product/category/flower">
                  <a className="btn">Shop the bouquets</a>
                </Link>
