    ...
    >
      <Container>
        <Row>
          ...
          <Col md={6} lg={6} xl={6}>
            <Widget title="Холбоо барих">
              <address>
                <p>
                  <span>Address:</span> 2548 Broaddus Maple Court Avenue,
                  Madisonville KY 4783, USA
                </p>
                <p>
                  <span>Phone:</span> +777 2345 7885; +777 2345 7886
                </p>
                <p>
                  <span>Hours:</span> 7 Days a week from 10 am to 6 pm
                </p>
                <p>
                  <span>E-mail:</span>{" "}
